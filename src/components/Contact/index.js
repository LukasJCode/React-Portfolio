        ...
        <div id="contact" className="contact-container">
            ...
            <div>
                <div className="row">
                    ...
                    <div className="col contact-icons">
                        <div>
                            <a href="https://www.facebook.com/lukas.jurgilas.98"><FacebookIcon style={{ fontSize: 100, color:"white" }}/></a>
                        </div>
                        <div>
                            <a href="https://github.com/LukasJCode"><GitHubIcon style={{ fontSize: 100, color:"white" }}/></a>
                        </div>
                        <div>
                            <a href="https://www.linkedin.com/in/lukas-jurgilas/"><LinkedInIcon style={{ fontSize: 100, color:"white" }}/></a>
                        </div>
                    </div>
                </div> 
            </div>
